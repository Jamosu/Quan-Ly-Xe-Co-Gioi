  ...
  const complexesData = [
    {
      ...
      drivers: [
        { name: 'Nguyễn Văn Hùng', code: 'KM-TX-001', pos: 'Lái xe đầu kéo Container', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
        { name: 'Trần Đình Trọng', code: 'KM-TX-002', pos: 'Thợ vận hành máy cày Kubota', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Lê Hoàng Long', code: 'KM-TX-003', pos: 'Tài xế xe ben 10T chở chuối', lic: DriverLicenseClass.HANG_C },
        { name: 'Phạm Minh Tuấn', code: 'KM-TX-004', pos: 'Thợ vận hành máy kéo John Deere', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Vũ Quốc Huy', code: 'KM-TX-005', pos: 'Lái xe bồn tưới nước tự động', lic: DriverLicenseClass.HANG_C },
        { name: 'Sokha Rith', code: 'KM-TX-006', pos: 'Thợ máy đào xới đất', lic: DriverLicenseClass.HANG_B2 },
        ...
        { name: 'Đỗ Hữu Nghĩa', code: 'KM-TX-009', pos: 'Thợ vận hành máy phun thuốc', lic: DriverLicenseClass.HANG_B2 },
        ...
        { name: 'Đinh Công Toàn', code: 'KM-TX-012', pos: 'Lái xe container lạnh xuất khẩu', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
      ],
      vehicles: kmVehicles,
    },
    {
      ...
      drivers: [
        { name: 'Phan Văn Đức', code: 'SN-TX-001', pos: 'Lái xe đầu kéo Container lạnh', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
        { name: 'Võ Minh Trí', code: 'SN-TX-002', pos: 'Thợ vận hành máy cày Kubota M7040', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Hồ Tấn Tài', code: 'SN-TX-003', pos: 'Tài xế xe bồn chở nước & mật rỉ', lic: DriverLicenseClass.HANG_C },
        { name: 'Ngô Quang Hải', code: 'SN-TX-004', pos: 'Thợ vận hành máy kéo John Deere', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Meas Samnang', code: 'SN-TX-005', pos: 'Lái xe ben Howo 10T chở phân', lic: DriverLicenseClass.HANG_C },
        { name: 'Rithy Panha', code: 'SN-TX-006', pos: 'Thợ vận hành máy băm cỏ TMR', lic: DriverLicenseClass.HANG_B2 },
        ...
        { name: 'Heng Sambath', code: 'SN-TX-009', pos: 'Thợ lái máy san gạt đường lô', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Trương Đình Luật', code: 'SN-TX-010', pos: 'Lái xe bán tải kiểm tra vườn cao su', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Nguyễn Thành Chung', code: 'SN-TX-011', pos: 'Lái xe đầu kéo bồn sữa/thức ăn', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
        { name: 'Bun Rith', code: 'SN-TX-012', pos: 'Thợ vận hành máy đào mương tiêu', lic: DriverLicenseClass.HANG_B2 },
      ],
      vehicles: snVehicles,
    },
    {
      ...
      drivers: [
        { name: 'Khamphou Somlith', code: 'NL-TX-001', pos: 'Thợ vận hành máy gặt đập liên hợp', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Bounmy Sisavath', code: 'NL-TX-002', pos: 'Thợ vận hành máy cày Kubota', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Nguyễn Văn Quyết', code: 'NL-TX-003', pos: 'Lái xe đầu kéo vận chuyển nông sản', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
        { name: 'Soukthavy Phone', code: 'NL-TX-004', pos: 'Tài xế xe ben 10T chở nông sản', lic: DriverLicenseClass.HANG_C },
        { name: 'Vongdeuan Khamsing', code: 'NL-TX-005', pos: 'Thợ vận hành máy kéo John Deere 75HP', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Đoàn Văn Hậu', code: 'NL-TX-006', pos: 'Lái xe bồn cấp nước sinh hoạt & trang trại', lic: DriverLicenseClass.HANG_C },
        { name: 'Saysana Bouttavong', code: 'NL-TX-007', pos: 'Thợ vận hành máy gieo hạt tự động', lic: DriverLicenseClass.HANG_B2 },
        ...
        { name: 'Phommavong Phout', code: 'NL-TX-010', pos: 'Thợ lái máy cày xới đất đa năng', lic: DriverLicenseClass.HANG_B2 },
        { name: 'Lê Văn Xuân', code: 'NL-TX-011', pos: 'Tài xế xe cẩu cứu hộ nông trường', lic: DriverLicenseClass.HANG_C },
        { name: 'Sengdeuan Keo', code: 'NL-TX-012', pos: 'Lái xe đầu kéo mooc sàn chở máy', lic: (DriverLicenseClass.HANG_CE || 'HANG_CE') },
      ],
      vehicles: nlVehicles,
    },
  ];
