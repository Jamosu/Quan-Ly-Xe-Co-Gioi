...
const PATH_NAMES: Record<string, string> = {
  ...
  'tai-san-khac': 'Máy phụ trợ & Khác',
  'may-thiet-bi': 'Máy & tài sản độc lập',
  ...
  'quan-ly-co-gioi': 'Quản lý cơ giới & Khu vực',
  'quan-ly-khu-vuc': 'Quản lý xe & Khu vực phụ trách',
